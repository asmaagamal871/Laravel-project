    ...
    <div style="margin: 40px;">
        <div class="card mt-6">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Delivery address: {{ $order->address()->first()->st_name }},
                    {{ $order->address->building_no }}, {{ $order->address->floor_no }}, {{ $order->address->flat_no }}</p>
        ...
        <div class="card mt-6">
            ...
            <div class="card-body">
                @foreach ($order->prescriptions()->get() as $prescription)
                    <img src="{{ Storage::url($prescription->prescription) }}"
                        alt="{{ Storage::path($prescription->prescription) }}" width="350px">
                @endforeach
            </div>
        </div><br>
